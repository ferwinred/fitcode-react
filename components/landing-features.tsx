...
import { TrendingUp, Zap, Users, type LucideIcon } from "lucide-react";
...
// Static data — features are not dynamic content from DB, but kept here
// for easy future replacement with a CMS or /api/features endpoint
...
export default function LandingFeatures() {
  ...
  useEffect(() => {
    // TODO → fetch("/api/features") cuando el backend esté listo
